/**
 * Add/Edit Personal Gift Item Screen
 *
 * Allows users to add a new item to a personal gift registry or edit an existing item.
...
/**
 * AddEditPersonalGiftItemScreen component
 *
 * @param {AddEditPersonalGiftItemScreenProps} props
 * @returns {JSX.Element}
 */
export default function AddEditPersonalGiftItemScreen({ navigation, route }) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (err.isAuthError) {
        console.log('[AddEditPersonalGiftItem] Auth error detected - user will be logged out');
        return;
      }
